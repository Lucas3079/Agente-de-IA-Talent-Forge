"""pdfplumber → extrai texto de arquivos PDF
smtplib → envia e-mails via protocolo SMTP
email.message.EmailMessage → cria e organiza mensagens de e-mail
re → valida e encontra padrões de texto com regex
os → acessa e manipula arquivos e pastas
typing (Dict, Tuple) → define tipos para funções e retornos
classes e funções personalizadas → analisam currículos, contam palavras-chave e classificam candidatos"""
